...
namespace IdentityProvider.Migrations.AuthServer
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorizationCodeExpiration = table.Column<int>(type: "int", nullable: false),
                    JwksExpiration = table.Column<int>(type: "int", nullable: false),
                    ...
                    IdTokenSignedResponseAlg = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 8, "authserver:clientconfiguration" }
                });
